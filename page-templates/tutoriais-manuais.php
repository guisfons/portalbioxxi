...
?>
    ...
    <hr/>
    <section class="wrapper tutoriais-manuais">
        <?php
            $args = array(
                'post_type'      => 'tutoriais_manuais',
                'posts_per_page' => -1,
                'post_status'    => 'publish',
            );
